/******************************************************************************
* File Name: SW_UART_TEST_USB_AsmGnu.s
* Version 1.50
*
*  Description:
...
/******************************************************************************
* Function Name: SW_UART_TEST_USB_PutChar
*******************************************************************************
*
* Summary:
...
*
******************************************************************************/
/* void SW_UART_TEST_USB_PutChar(uint8 txDataByte) */
.align 3                     /* Align to 8 byte boundary (2^n) */
.global SW_UART_TEST_USB_PutChar
.func SW_UART_TEST_USB_PutChar, SW_UART_TEST_USB_PutChar
.type SW_UART_TEST_USB_PutChar, %function
.thumb_func
SW_UART_TEST_USB_PutChar:
SetPinMode:
...
bitTxLoop:
    ...
    .align 3
PORT_DR_ADDRESS:
    .word SW_UART_TEST_USB_pinDrAdress
FREQ:
