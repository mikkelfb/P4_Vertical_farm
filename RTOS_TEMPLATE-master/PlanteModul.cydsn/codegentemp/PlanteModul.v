...
module I2C_v3_50_6 (
	...
	cy_clock_v1_0
		#(.id("52125022-d772-42f5-83b4-ab54e68f6d73/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("99ffb4a5-fb51-43b3-b4e7-3e8c66f9ef9b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("21f746f5-edda-48b4-8cc8-c49aeeaffc91"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
