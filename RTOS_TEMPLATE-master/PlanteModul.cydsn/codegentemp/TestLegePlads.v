// ======================================================================
// TestLegePlads.v generated from TopDesign.cysch
// 04/15/2020 at 23:05
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("14bb1d65-2109-44fb-a575-b763e35c5770"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fa0745ae-e057-4029-b073-4b832ddabecb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("18cb6bee-a4ec-4935-ae0d-c81d829aaf92"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
