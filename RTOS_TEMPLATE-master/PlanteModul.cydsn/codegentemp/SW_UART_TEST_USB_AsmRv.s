;==============================================================================
; File Name: SW_UART_TEST_USB_AsmRv.s
; Version 1.50
;
;  Description:
...
;==============================================================================
    ...
    IMPORT SW_UART_TEST_USB_pinDrAdress
...
; void SW_UART_TEST_USB_PutChar(uint8 txDataByte)
    ALIGN 8
SW_UART_TEST_USB_PutChar FUNCTION
    EXPORT SW_UART_TEST_USB_PutChar
SetPinMode
...
PORT_DR_ADDRESS DCD SW_UART_TEST_USB_pinDrAdress
