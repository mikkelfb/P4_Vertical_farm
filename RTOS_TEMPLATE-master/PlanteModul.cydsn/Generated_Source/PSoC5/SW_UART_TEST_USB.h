...
#ifndef CY_SW_TX_UART_SW_UART_TEST_USB_H
#define CY_SW_TX_UART_SW_UART_TEST_USB_H

#include "cytypes.h"
#include "cyfitter.h"
#include "cypins.h"

#define SW_UART_TEST_USB_BAUD_RATE                      (115200u)
#define SW_UART_TEST_USB_PIN_STATIC_MODE                (1u)
...
#endif /* CY_SW_TX_UART_SW_UART_TEST_USB_H */
