...
module I2C_v3_50_0 (
	...
	cy_clock_v1_0
		#(.id("31d49299-79c4-4a14-980f-adde9f8a0003/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module SW_Tx_UART_v1_50_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d3825a46-52c2-4754-8be0-d665de27bcf5/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__SDA_PIN_net;
	wire [0:0] tmpFB_0__SDA_PIN_net;
	wire [0:0] tmpINTERRUPT_0__SDA_PIN_net;
	electrical [0:0] tmpSIOVREF__SDA_PIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		SDA_PIN
		 (.oe(tmpOE__SDA_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SDA_PIN_net[0:0]}),
		  .io({Net_1}),
		  .siovref(tmpSIOVREF__SDA_PIN_net),
		  .interrupt({tmpINTERRUPT_0__SDA_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SDA_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SCL_PIN_net;
	wire [0:0] tmpFB_0__SCL_PIN_net;
	wire [0:0] tmpINTERRUPT_0__SCL_PIN_net;
	electrical [0:0] tmpSIOVREF__SCL_PIN_net;

	cy_psoc3_pins_v1_10
		#(.id("2dea3bfe-7b8a-4c48-8d5e-d6f5ecf5073e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SCL_PIN
		 (.oe(tmpOE__SCL_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SCL_PIN_net[0:0]}),
		  .io({Net_2}),
		  .siovref(tmpSIOVREF__SCL_PIN_net),
		  .interrupt({tmpINTERRUPT_0__SCL_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCL_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
